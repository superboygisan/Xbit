...
SHRUTI_API_KEY = getenv("SHRUTI_API_KEY" , 'ShrutiBotsb3b3J2YjziC6bxgS6TXp' ) ## Your API key like: xbit_10000000xx0233 Get from  https://t.me/tgmusic_apibot
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/superboygisan/Xbit",
)
